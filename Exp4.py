...
def app():
    ...
    prediction = rfc_new.predict(data_input)[0]

    # Analyze the prediction and print out the recommended action
    if prediction == "Buy":
        st.subheader("Recommendation")
        st.write("This stock is a good buy!")
    elif prediction == "Sell":
        st.subheader("Recommendation")
        st.write("This stock is a good sell!")
    else:
        st.subheader("Recommendation")
        st.write("This stock can be hold.")
